...
object RssXmlBuilder {
    ...
    fun buildFeedXml(feed: Feed, articles: List<Article>, baseUrl: String): String {
        ...
        writer.write("<rss version=\"2.0\" xmlns:content=\"http://purl.org/rss/1.0/modules/content/\">\n")
        writer.write("  <channel>\n")
        writer.write("    <title>${escapeXml(feed.title)}</title>\n")
        writer.write("    <link>${escapeXml(baseUrl)}/feed/${feed.id}/rss.xml</link>\n")
        writer.write("    <description>Full-text feed generated by RSS-Feeder</description>\n")
        ...
        for (article in articles) {
            ...
            if (article.summary != null) {
                writer.write("      <description>${escapeXml(article.summary)}</description>\n")
            }
